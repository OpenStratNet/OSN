...
// Allow rules
  Images.allow({
    insert: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.Images.insert)) {
          return true;
        }
      }
      return false;
    ...
    update: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.Images.update)) {
          return true;
        }
      }
      return false;
    ...
    download: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.Images.download)) {
          return true;
        }
      }
      return false;
  ...
  Attachments.allow({
    insert: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.Attachments.insert)) {
          return true;
        }
      }
      return false;
    ...
    update: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.Attachments.update)) {
          return true;
        }
      }
      return false;
    ...
    download: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.Attachments.download)) {
          return true;
        }
      }
      return false;
  ...
  ProfilePic.allow({
    insert: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.ProfilePic.insert)) {
          return true;
        }
      }
      return false;
    ...
    update: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.ProfilePic.update)) {
          return true;
        }
      }
      return false;
    ...
    download: function (userId) {
      if (userId) {
        if (Roles.userIsInRole(userId, Meteor.settings.allow.ProfilePic.download)) {
          return true;
        }
      }
      return false;
